...
pygame.mixer.music.load('sound/lvl3.wav')
...
enemy3_info = ImageInfo([84, 132], 40)
...
class Background(pygame.sprite.Sprite):
    ...
    def __init__(self, image_file, location):
        ...
        self.image = pygame.image.load("images\scene3.png")
...
background = Background("images\scene3.png", [0,0])
x=0
while True:
    #Background follows
    ...
    if x == 600 or x == 1200:
        x = 0
    #Spawning of enemies
    if count % frequency == 0 and score <= 960:
        Enemylist.append(Enemy(random.randint(66,650),0.1, enemy3_img, enemy3_info))
    if count > 1000:
        count = 0
    ...
    for enemy in Enemylist:
        ...
        screen.blit(enemy3_img, (enemy.x, enemy.y))
